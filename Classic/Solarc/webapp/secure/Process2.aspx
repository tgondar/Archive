<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" ValidateRequest="false" MasterPageFile="~/webapp/secure/mp.master" AutoEventWireup="true" Inherits="Solarc.webapp.secure.Process2" Codebehind="Process2.aspx.cs" %>
...
<%@ Register src="wucProcessDetails.ascx" tagname="wucProcessDetails" tagprefix="uc3" %>

<%@ Register src="wucPEPayment.ascx" tagname="wucPEPayment" tagprefix="uc4" %>
    ...
    &nbsp;<asp:Label ID="Label68" runat="server" Text="3º"></asp:Label>
        ...
        <tr>
            <td colspan="2" class="textProcessFields">
                <uc4:wucPEPayment ID="wucPEPayment1" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="divContentMix" colspan="2">
