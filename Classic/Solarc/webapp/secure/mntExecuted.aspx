<%@ Page Title="" Language="C#" MasterPageFile="~/webapp/secure/mp.master" AutoEventWireup="true" Inherits="Solarc.webapp.secure.mntExecuted" Codebehind="mntExecuted.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="divContentFields">
        ...
        &nbsp;<asp:Label
                                                ID="Label6" runat="server" Text="BI" CssClass="textLabel"></asp:Label>&nbsp;<asp:TextBox
        ...
        <asp:CompareValidator ID="CompareValidator1" runat="server" 
            ControlToValidate="txtBornDate" CssClass="textError" ErrorMessage="*" 
            ForeColor="" Operator="DataTypeCheck" SetFocusOnError="True" Type="Date" 
            ValidationGroup="InsertSave"></asp:CompareValidator>
    ...
    <div class="divContentFields">
        <asp:GridView ID="gvExecuted" runat="server" AutoGenerateColumns="False" 
